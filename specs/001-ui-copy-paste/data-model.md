...
2. Calculate position offset (+2 grid units in X and Y).
3. For each `CopiedModule`:
    * Generate new unique name (Smart Increment).
    * Call `EVConfigModel.add_new_module_instance` with new name and config.
